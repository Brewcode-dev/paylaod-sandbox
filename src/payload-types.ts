...
/**
 * Konfiguracja synchronizacji z zewnętrznym API
 *
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "api-sync-config".
 */
export interface ApiSyncConfig {
  id: number;
  /**
   * URL bazowy API (np. https://api.example.com)
   */
  apiUrl: string;
  /**
   * Endpoint API do synchronizacji rezerwacji
   */
  endpoint: string;
  /**
   * JWT Bearer token do autoryzacji API
   */
  ...
  /**
   * Interwał synchronizacji w milisekundach (300000 = 5 minut)
   */
  syncInterval?: number | null;
  /**
   * Liczba prób retry w przypadku błędu
   */
  retryAttempts?: number | null;
  /**
   * Opóźnienie między próbami w milisekundach
   */
  ...
  syncStats?: {
    /**
     * Łączna liczba zsynchronizowanych rekordów
     */
    totalRecords?: number | null;
    /**
     * Liczba rekordów w ostatniej synchronizacji
     */
    lastRecordsProcessed?: number | null;
    /**
     * Liczba nowych rekordów w ostatniej synchronizacji
     */
    lastRecordsCreated?: number | null;
    /**
     * Liczba zaktualizowanych rekordów w ostatniej synchronizacji
     */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "api-sync-config_select".
 */
export interface ApiSyncConfigSelect<T extends boolean = true> {
  apiUrl?: T;
  endpoint?: T;
  jwtToken?: T;
  autoSync?: T;
